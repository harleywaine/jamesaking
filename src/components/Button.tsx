...
export default function Button({
  ...
  const variantClasses = {
    primary: 'bg-white text-gray-900 hover:bg-gray-100 focus:ring-gray-500 shadow-lg hover:shadow-xl transform hover:-translate-y-1 hover:scale-105',
    secondary: 'bg-white text-gray-900 hover:bg-gray-100 focus:ring-gray-500 shadow-md hover:shadow-lg transform hover:-translate-y-0.5',
