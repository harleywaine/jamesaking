    ...
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 border-t border-gray-200">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="text-4xl font-light mb-6 text-gray-900">You are the answer. You are the asset.</h2>
            <p className="text-xl text-gray-600 leading-relaxed">
            The future won’t be saved by average. It will be built by the excellent. Install systems that win — the world will follow.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 border-t border-gray-200">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="aspect-[4/3] rounded-lg overflow-hidden">
              <img 
                src="/images/Screenshot 2025-09-05 at 11.52.30.png" 
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="pt-4 space-y-3">
                  <div className="flex items-center gap-3">
                    <span className="text-sm text-gray-600">Be first to access your portable competitive edge →</span>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="aspect-video rounded-lg overflow-hidden bg-gray-100 border border-gray-200">
                <img 
                  src="/images/Screenshot 2025-08-29 at 17.17.49.png" 
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-3xl font-light text-gray-900">Excellence - Open Source</h2>
              </div>
              <p className="text-lg text-gray-600 leading-relaxed">
                Direct transmissions from James A. King. Pressure-tested frameworks. Long-form lectures. Decoded systems. For those serious about engineering excellence.
              </p>
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <span className="text-sm text-gray-600">Latest Episode →</span>
                  <a href="#" className="text-sm text-gray-600 hover:text-gray-900 transition-colors border-b border-gray-300 hover:border-gray-900">Watch Now</a>
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-sm text-gray-600">Join the Elite →</span>
                  <a href="#" className="text-sm text-gray-600 hover:text-gray-900 transition-colors border-b border-gray-300 hover:border-gray-900">Subscribe</a>
                </div>
              </div>
            </div>
          </div>
